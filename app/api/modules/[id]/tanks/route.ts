...
const createSchema = z.object({
  ...
  tankOutletValveSubType: z.enum(['BUTTERFLY', 'SINGLE_SEAT', 'SINGLE_SEAT_TANK', 'SW_CIP_TANK', 'SD_TANK', 'D_TANK']).optional(),
  manifoldHasCipReturnPump: z.boolean().default(false),
