...
import { renderMilkReceptionDiagram, DIAGRAM_REL_ID, DIAGRAM_FILENAME } from '@/lib/docx/diagram';
...
export async function POST(req: Request, { params }: Params) {
  try {
    ...
    return apiSuccess(
      { ...docRecord, downloadUrl: `/api/milk-reception-modules/${moduleId}/documents/${docRecord.id}` },
      'Belge oluşturuldu',
    );
  } catch (e: unknown) {
